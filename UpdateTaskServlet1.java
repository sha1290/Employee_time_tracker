...
@WebServlet("/UpdateTaskServlet1")
public class UpdateTaskServlet1 extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            // Obtain connection from DatabaseConnection class
            ...
            // Send HTML response with styled alert message
            ...
            out.println(message);
            out.println("</div>");
            out.println("<script>setTimeout(() => { window.location.href = 'modify1.jsp'; }, 3000);</script>"); // Redirect to dashboard after 3 seconds
